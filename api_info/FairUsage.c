FairUsage()
{
	...
	lr_start_transaction("api_1_0_info_fairUsage");
		
	web_url("api_1_0_info_fairUsage",
		"URL=http://{endpoint}/api/1.0/info/fairUsage?hash={hash_qouted}&ctn={ctn}",
		"Resource=1",
	...
	checkResult("api_1_0_info_fairUsage", lr_eval_string("{response}"), lr_eval_string("{token}"), lr_eval_string("{ctn}"), "");
