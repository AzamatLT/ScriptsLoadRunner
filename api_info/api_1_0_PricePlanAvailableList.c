api_1_0_PricePlanAvailableList()
{
	...
	lr_start_transaction("api_1_0_info_pricePlanAvailableList");
	...
	if (i<2) {
		web_url("api_1_0_info_pricePlanAvailableList",
		"URL=http://{endpoint}/api/1.0/info/pricePlanAvailableList?ctn={ctn}&hash={hash_qouted}&channelType={channelType}",
        "Resource=1",
		...
		web_url("api_1_0_info_pricePlanAvailableList",
		"URL=http://{endpoint}/api/1.0/info/pricePlanAvailableList?ctn={ctn}&hash={hash_qouted}",
        "Resource=1",
		"RecContentType=text/html",
		"Referer=",
		"Mode=HTML",
	...
	checkResult("api_1_0_info_pricePlanAvailableList", lr_eval_string("{response}"), lr_eval_string("{token}"), lr_eval_string("{ctn}"), "");
