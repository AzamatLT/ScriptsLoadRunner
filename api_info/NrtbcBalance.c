NrtbcBalance()
{
	...
	lr_start_transaction("api_1_0_info_nrtbcBalance");
		
	web_url("api_1_0_info_nrtbcBalance",
		"URL=http://{endpoint}/api/1.0/info/nrtbcBalance?hash={hash_qouted}&ban={ctnban_ban}",
		"Resource=1",
	...
	checkResult("api_1_0_info_nrtbcBalance", lr_eval_string("{response}"), lr_eval_string("{systoken}"), lr_eval_string("{ctnban_ctn}"), lr_eval_string("{fullresponse}"));
