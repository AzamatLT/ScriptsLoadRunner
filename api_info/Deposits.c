Deposits()
{
	...
	lr_start_transaction("api_1_0_info_deposits");
		
	web_url("api_1_0_info_deposits",
		"URL=http://{endpoint}/api/1.0/info/deposits?hash={hash_qouted}&login={postpaid_ban}",
		"Resource=1",
	...
	checkResult("api_1_0_info_deposits", lr_eval_string("{response}"), lr_eval_string("{token}"), lr_eval_string("{postpaid_ban}"), "");
