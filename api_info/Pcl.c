Pcl()
{
	...
	web_url("api_1_0_info_pcl",
		"URL=http://{endpoint}/api/1.0/info/pcl?ctn={ctn}&hash={hash_qouted}",
		"Resource=1",
	...
	checkResult("api_1_0_info_pcl", lr_eval_string("{response}"), lr_eval_string("{token}"), lr_eval_string("{ctn}"), "");
