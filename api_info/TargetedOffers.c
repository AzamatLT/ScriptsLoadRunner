TargetedOffers()
{
	...
	lr_start_transaction("api_1_0_info_targetedOffers");
		
	web_url("api_1_0_info_targetedOffers",
		"URL=http://{endpoint}/api/1.0/info/targetedOffers?ctn={ctn}&hash={hash_qouted}&channelType={channelType}",
		"Resource=1",
	...
	lr_end_transaction("api_1_0_info_targetedOffers", LR_AUTO);
	//checkResult("api_1_0_info_targetedOffers", lr_eval_string("{response}"), lr_eval_string("{token}"), lr_eval_string("{ctn_post_target}"), "");
