BillPeriods()
{
	...
	lr_start_transaction("api_1_0_info_billPeriods");
		
	web_url("api_1_0_info_billPeriods",
		"URL=http://{endpoint}/api/1.0/info/billPeriods?hash={hash_qouted}&ctn={ctn}",
		"Resource=1",
	...
	checkResult("api_1_0_info_billPeriods", lr_eval_string("{response}"), lr_eval_string("{token}"), lr_eval_string("{ctn}"), "");
