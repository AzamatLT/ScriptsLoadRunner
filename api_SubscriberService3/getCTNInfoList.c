getCTNInfoList()
{
	if (pool_get_hash(lr_eval_string("{ban}{ctn}")) == 0) {
		...
		"Body=<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?><soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:urn=\"urn:uss-wsapi:Subscriber\"><soapenv:Header/><soapenv:Body><urn:getCTNInfoList><token>180C4B754700AF2C02C5CF94CD0A7117</token><hash></hash><login>МЕЧТА</login><ban>320890213</ban><ctn>{rel45_tmp}</ctn></urn:getCTNInfoList></soapenv:Body></soapenv:Envelope>", 
		LAST ); 
